         ...
         <div class="login_box_main_wrapper" id="login_height">
            <div class="container">
               <div class="login-logo">
                  <a href="index.html"> <img src="images/index1-logo.png" alt="logo"> </a>
               </div>
                        ...
                        <div class="left-side">
                           ...
                           <form method="POST" action="{{ route('login.attempt') }}">
                              ...
                              <div class="login-btn-sec">
                                 <button type="submit" class="sub-btn"><span>Sign In</span></button>
                                 <div class="social-btn">
                                   ...
                                   <a href="javascript:;"> <span> <svg viewBox="0 0 25 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                       ...
                                       <li>
                                <a href="javascript:;"> <span><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                ...
                                <a href="javascript:;"> <span>
                                 ...
                                 <p>Do have an account? <a href="{{ route('register') }}">Sign Up now!</a></p>
                              </div>
                           </form>
                       </div>
                     </div>
