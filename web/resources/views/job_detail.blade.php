            ...
            <div class="col-lg-8 col-md-12 mb-4">
                <div class="trending-main-box float_left">
                    <div class="trending-lower-text" style="padding: 30px;">
                        ...
                        <p style="color: #666; font-size: 1rem; margin-bottom: 10px;">Oleh: <strong id="freelancer-name"></strong></p>
                        <p id="job-price" style="font-size: 1.2rem; font-weight: bold; color: #007bff; margin-bottom: 20px;"></p>
                        
                        <hr style="border-top: 1px solid #eee; margin: 20px 0;">

                        <h3 style="font-size: 1.5rem; font-weight: bold; margin-bottom: 10px;">Deskripsi Jasa</h3>
                        <p id="job-description" style="line-height: 1.6; margin-bottom: 25px;"></p>
                        
                        <h3 style="font-size: 1.5rem; font-weight: bold; margin-bottom: 10px;">Layanan yang Ditawarkan</h3>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="trending-main-box float_left" style="position: -webkit-sticky; position: sticky; top: 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                    <div class="trending-lower-text text-center" style="padding: 25px;">
                        <h3 style="font-size: 1.5rem; font-weight: bold; margin-bottom: 20px;">Profil Freelancer</h3>
                        ...
                        <h5 style="font-size: 1.1rem; font-weight: bold; text-align: left; margin-top: 25px; margin-bottom: 10px;">Ringkasan Pengalaman</h5>
                        <p id="freelancer-summary" style="text-align: left; line-height: 1.5; color: #555;"></p>
                        
                        <h5 style="font-size: 1.1rem; font-weight: bold; text-align: left; margin-top: 20px; margin-bottom: 10px;">Keahlian Utama (Cyber)</h5>
                        ...
                        <div style="margin-top: 15px;">
                            <a href="{{ route('checkout') }}" class="custom-btn" style="width: 100%; display: block;"><span><i class="fas fa-shopping-cart"></i> Pesan Jasa Ini</span></a>
                        </div>
